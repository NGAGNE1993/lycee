...
public interface ConcoursRepository extends JpaRepository<Concours, Long> {
    ...
    @Query(
        value = "select distinct concours from Concours concours left join fetch concours.lyceesTechniques left join fetch concours.directeur",
    ...
    @Query("select distinct concours from Concours concours left join fetch concours.lyceesTechniques left join fetch concours.directeur")
    List<Concours> findAllWithToOneRelationships();

    @Query(
        "select concours from Concours concours left join fetch concours.lyceesTechniques left join fetch concours.directeur where concours.id =:id"
    )
