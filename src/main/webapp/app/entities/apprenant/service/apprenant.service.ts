...
export class ApprenantService {
  ...
  protected convertDateFromClient(apprenant: IApprenant): IApprenant {
    return Object.assign({}, apprenant, {
      ...
      anneeScolaire: apprenant.anneeScolaire?.isValid() ? apprenant.anneeScolaire.format(DATE_FORMAT) : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((apprenant: IApprenant) => {
        ...
        apprenant.anneeScolaire = apprenant.anneeScolaire ? dayjs(apprenant.anneeScolaire) : undefined;
      });
    }
    return res;
  }
