...
describe('Filiere Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      ...
      nomAutre: 'AAAAAAA',
      nomProgramme: SANTEBIOLOGIECHIMIE.AGENT_DE_SANTE_COMMUNAUTAIRE,
      autreAGR: 'AAAAAAA',
      nomProgrammeEl: ELEVAGE.AVICULTURE,
      autreEL: 'AAAAAAA',
      autreMIN: 'AAAAAAA',
      autreBAT: 'AAAAAAA',
      autreMECAN: 'AAAAAAA',
      autreMENU: 'AAAAAAA',
      autreAGRO: 'AAAAAAA',
      autreELECTRO: 'AAAAAAA',
      autreSTRUC: 'AAAAAAA',
      autreEC: 'AAAAAAA',
      autreCOM: 'AAAAAAA',
      autreIN: 'AAAAAAA',
      autreSAN: 'AAAAAAA',
      autreProgramme: 'AAAAAAA',
    };
  });
  ...
  describe('Service methods', () => {
    ...
    describe('addFiliereToCollectionIfMissing', () => {
      ...
      it('should add only unique Filiere to an array', () => {
        const filiereArray: IFiliere[] = [{ id: 123 }, { id: 456 }, { id: 8094 }];
